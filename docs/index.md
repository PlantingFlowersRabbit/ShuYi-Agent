...
| [docs/development/acceptance-standard.md](./development/acceptance-standard.md) | v0.1 验收标准：判定是否做完的基准。 |
| [docs/development/test-strategy.md](./development/test-strategy.md) | v0.1 测试策略：把验收标准转成自动测试和人工证据。 |
