...
NovelVoice-Agent 是一个小说辅助生成故事配音的 agent 项目。v0.12 交付人工主导的人机协作工作台：导入 txt 小说，先生成轻量章节目录，选择某个章节后才加载并拆分该章正文，维护音色资源库和可新增角色列表，人工确认段落无误后用 Qwen/Qwen3-8B 生成嵌套的可编辑说话人粒度语句草稿，再由用户校正角色、音色、情绪、语速、音量和其他控制文本，最后调用本地 TTS/VoiceDesign 服务生成音频。
