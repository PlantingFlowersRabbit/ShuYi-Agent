...
v0.14 在 v0.13 的人工协作工作台基础上，修复段落确认旧状态，改为 Qwen/Qwen3-8B 说话人粒度划分，并补强音频控制、音色生成预览和模型配置启动反馈。

## 当前状态

- 规格和验收文档已在 `spec/` 与 `docs/` 中建立，当前版本目标见 `spec/v0.14-harness.md`。
...
3. 当前任务相关 `spec/*.md`，v0.14 默认读 `spec/v0.14-harness.md`
...
该脚本检查 harness 文件、docs 索引、manifest 和入库样本音频解码；真实 UI、模型和 TTS 仍需按 `docs/development/v0.14-verification.md` 取证。
